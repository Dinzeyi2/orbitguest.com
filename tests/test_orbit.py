...
class OrbitFlowTest(unittest.TestCase):
    ...
    def test_restaurant_offer_link_sends_real_first_offer_and_claim_links_exact_pos_guest(self):
        ...
        self.assertIn('By entering your phone number you expressly agree to our <a href="/terms"', markup)
        self.assertNotIn("Message frequency varies", markup)
        self.assertNotIn("Your mobile information will not be sold or shared", markup)
