...
class Handler(BaseHTTPRequestHandler):
    ...
    def _enrollment_html(self, slug, page):
        ...
        <div class="brand">{merchant}</div><h1>{headline}</h1><div class="offer">Get {html.escape(label)} your next purchase</div><form id="join"><label for="phone">Mobile phone number</label><input id="phone" type="tel" inputmode="tel" autocomplete="tel" placeholder="+1 555 123 4567" required><p class="consent">By entering your phone number you expressly agree to our <a href="/terms" target="_blank" rel="noopener">terms</a> and <a href="/privacy" target="_blank" rel="noopener">privacy</a>.</p><small>{terms}</small><button id="submit" type="submit">Text me the promo code</button></form><div id="result" role="status"></div>
